/*
* NEW BrowserCompAPI version 1.0.0.47
...
conduit.tabs.executeScript(tabId || null, { code: "function EBCallBackMessageReceived(data) { conduitPage.sendRequest('EBCallBackMessageReceived', data); }" });
}
