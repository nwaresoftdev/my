    ...
    try{
        switch(_browserType){
            ...
            default:{
                ...
                OpenGadget(_defaultHost+url + "?fromToolbar=yes",width,height,'openposition=alignment:(B;L),savelocation=0, saveresizedsize=0,closeonexternalclick=0,titlebar='+t+',closebutton='+c+',resizable=no');
                break;
            }
        }
    }catch(e){
